...
// const ReviewComplaintsLink = (props) => (
//   <Link to="/app/review-complaints" {...props} />
// );
// const ReviewInquiriesLink = (props) => (
//   <Link to="/app/review-inquiries" {...props} />
// );
          ...
          <Toolbar disableGutters={!open}>
            <Typography variant="h6" color="inherit" className={classes.grow}>
              ...
              {userCan(signedInUser, null, USER_ACTIONS.CAN_REVIEW_INCIDENTS) && (
                <Button
                  variant={
                    selectedMainSection === "review" ? "outlined" : "flat"
                  }
                  color="inherit"
              ...
              {userCan(signedInUser, null, USER_ACTIONS.CAN_VIEW_REPORTS) && (
                <Button
                  variant={
                    selectedMainSection === "reports" ? "outlined" : "flat"
                  }
                  color="inherit"
              ...
              {userCan(
                ...
                <Button
                  variant={
                    selectedMainSection === "archive" ? "outlined" : "flat"
                  }
                  color="inherit"
